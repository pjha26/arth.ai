...
{/* TopNavBar */}
<nav className="bg-surface/80 dark:bg-surface-dim/80 backdrop-blur-md text-primary dark:text-primary-fixed font-body-md text-body-md fixed top-0 w-full z-50 border-b border-outline-variant/30 dark:border-outline/20">
...
<a className="text-on-surface-variant dark:text-surface-variant hover:text-primary dark:hover:text-primary-fixed transition-colors" href="/">Product</a>
<a className="text-on-surface-variant dark:text-surface-variant hover:text-primary dark:hover:text-primary-fixed transition-colors" href="/">Solutions</a>
<a className="text-on-surface-variant dark:text-surface-variant hover:text-primary dark:hover:text-primary-fixed transition-colors" href="/">Philosophy</a>
<a className="text-on-surface-variant dark:text-surface-variant hover:text-primary dark:hover:text-primary-fixed transition-colors" href="/">Pricing</a>
</div>
<div className="hidden md:flex items-center gap-stack-md">
<button className="text-on-surface-variant dark:text-surface-variant hover:text-primary dark:hover:text-primary-fixed transition-colors font-body-md">Login</button>
...
{/* Hero Section */}
<section className="px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto py-section-gap md:py-[120px] text-center flex flex-col items-center">
<div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-surface-container-low border border-outline-variant/50 mb-stack-lg reveal">
...
<p className="font-body-md text-body-md text-on-surface-variant mb-stack-lg">Built for modern SaaS teams. Privacy-first by design.</p>
...
<section className="bg-surface py-section-gap border-t border-outline-variant/30">
<div className="px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto text-center reveal">
<h2 className="font-headline-md text-headline-md text-on-surface mb-stack-md">Quiet Intelligence in Motion</h2>
<p className="font-body-md text-body-md text-on-surface-variant max-w-[600px] mx-auto mb-stack-lg">Experience how subtle contextual shifts create a tailored journey for different personas.</p>
<div className="inline-flex bg-surface-container rounded-full p-1 mb-section-gap">
...
<div className="max-w-[800px] mx-auto bg-surface-container-low border border-outline-variant/50 rounded-2xl p-section-gap text-left relative overflow-hidden group hover:shadow-md transition-shadow">
<div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-primary-fixed-dim to-transparent"></div>
<span className="inline-block px-3 py-1 bg-primary/10 text-primary rounded-full text-label-caps font-label-caps mb-stack-md">Detected: Startup Founder</span>
<h3 className="font-headline-md text-headline-md text-on-surface mb-stack-sm">Ship faster, learn quicker.</h3>
<p className="font-body-lg text-body-lg text-on-surface-variant mb-stack-lg">We know you're moving fast. Here's how our API integrates in under 5 minutes to help you find product-market fit without slowing down.</p>
<button className="text-primary font-body-md hover:underline underline-offset-4">Read the Founder Guide -&gt;</button>
</div>
</div>
</section>
{/* The Transformation */}
<section className="bg-surface-container-low py-section-gap border-t border-outline-variant/30">
<div className="px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto text-center reveal">
<h2 className="font-headline-md text-headline-md text-on-surface mb-stack-sm">The Transformation</h2>
<p className="font-body-md text-body-md text-on-surface-variant max-w-[600px] mx-auto mb-section-gap">Move from static, one-size-fits-all pages to dynamic, breathing experiences.</p>
...
<section className="bg-background py-section-gap border-t border-outline-variant/30">
<div className="px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto reveal">
<div className="text-center mb-section-gap">
<h2 className="font-headline-md text-headline-md text-on-surface mb-stack-sm">Contextual Adaptation</h2>
...
{/* SaaS Founder Card */}
<div className="bg-surface-container-low border border-outline-variant/50 rounded-xl p-stack-lg flex flex-col gap-stack-md hover:border-primary-fixed-dim hover:shadow-sm transition-all duration-300">
...
<div className="mt-auto pt-stack-md border-t border-outline-variant/30 flex items-center justify-between text-label-caps font-label-caps text-on-surface-variant">
...
{/* "How It Works" Flow */}
<section className="px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto py-section-gap reveal">
<h2 className="font-headline-md text-headline-md text-on-surface mb-stack-lg text-center">How we help you connect</h2>
<div className="relative flex flex-col md:flex-row justify-between items-start md:items-center gap-stack-lg mt-section-gap">
{/* Connector Line (Hidden on mobile) */}
<div className="hidden md:block absolute top-1/2 left-0 w-full h-[1px] bg-outline-variant/30 -z-10 -translate-y-1/2"></div>
<div className="flex flex-col items-center text-center bg-background px-stack-md w-full md:w-auto">
<div className="w-12 h-12 rounded-full bg-surface-container border border-outline-variant flex items-center justify-center mb-stack-md">
...
<div className="flex flex-col items-center text-center bg-background px-stack-md w-full md:w-auto">
<div className="w-12 h-12 rounded-full bg-on-surface text-surface flex items-center justify-center mb-stack-md">
...
{/* Footer */}
<footer className="bg-surface-container dark:bg-surface-container-highest text-on-surface dark:text-on-surface font-label-caps text-label-caps w-full py-stack-lg border-t border-outline-variant/30 mt-section-gap reveal">
<div className="flex flex-col md:flex-row justify-between items-center gap-stack-md px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto">
<div className="font-headline-sm text-headline-sm text-on-surface">
                ArthAI
            </div>
<div className="flex items-center gap-stack-md flex-wrap justify-center">
<a className="text-on-surface-variant dark:text-surface-variant hover:text-primary dark:hover:text-primary-fixed underline-offset-4 hover:underline transition-all" href="/">Privacy Policy</a>
<a className="text-on-surface-variant dark:text-surface-variant hover:text-primary dark:hover:text-primary-fixed underline-offset-4 hover:underline transition-all" href="/">Terms of Service</a>
<a className="text-on-surface-variant dark:text-surface-variant hover:text-primary dark:hover:text-primary-fixed underline-offset-4 hover:underline transition-all" href="/">Security</a>
<a className="text-on-surface-variant dark:text-surface-variant hover:text-primary dark:hover:text-primary-fixed underline-offset-4 hover:underline transition-all" href="/">Contact</a>
</div>
<div className="text-on-surface-variant dark:text-surface-variant">
