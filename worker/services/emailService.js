  ...
  <div style="max-width:600px;margin:0 auto;background:#07070f;">
    ...
    <div style="padding:40px;">
      ...
      <div style="text-align:center;margin-bottom:20px;display:flex;flex-direction:column;gap:12px;align-items:center;">
        <a href="${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000'}/report/${report.id}" 
        ...
        <a href="${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000'}/api/leads/${lead.id}/download" 
      ...
      <div style="text-align:center;margin-bottom:40px;font-size:13px;">
        <a href="mailto:?subject=AI Intelligence Report for ${encodeURIComponent(lead.companyName)}&body=Hey team,%0D%0A%0D%0AHere is the AI intelligence report generated by arth.ai for ${encodeURIComponent(lead.companyName)}:%0D%0A${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000'}/report/${report.id}" style="color:#a5b4fc;text-decoration:none;margin-right:16px;">
